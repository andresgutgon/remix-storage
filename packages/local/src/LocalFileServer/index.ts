...
export class LocalFileServer {
  ...
  constructor() {} // private router: RouterContract // private driver: LocalDriverContract, // private config: LocalDriverConfig, // private diskName: string,
  ...
  public registerRoute() {
    ...
    //
    // this.router
    //   .get(routePattern, async ({ response, request }) => {
    //     let location = request
    //       .param(LocalFileServer.filePathParamName)
    //       .join("/")
    //     try {
